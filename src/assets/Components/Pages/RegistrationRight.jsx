      ...
      <div>
        ...
        <form className='w-[456px] flex flex-col items-start justify-start gap-y-8' action="#">
           ...
           <div className='w-full'>
            ...
            <input className='w-full h-full bg-transparent outline-0 text-base font-normal leading-[26px] text-CommonColor placeholder-[#6C7275]' type="text" placeholder='Password'
           />
           <span>
           <IoEyeOffOutline className='text-lg text-[#6C7275] cursor-pointer'/>
           <IoEyeOutline className='text-lg text-[#6C7275] cursor-pointer'/>
            </span>
          </fieldset>
           </div>
           <div>
